...
public :
   ...
   TVectorD FillInputvector_7C(int size, int index1, int index2, int index3, int indtr1, int indtr2);
   TVectorD FillSigma2vector_7C(int size, int index1, int index2, int index3, int indtr1, int indtr2);
