  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    */
    ...
    for (int i = 0; i < 3; i ++) {// loop over number of photon candidates
      ...
      pionphoton1_tmp = Getphoton4vector(inputvect_permut(5), inputvect_permut(6) - xv_nvip1, inputvect_permut(7) - yv_nvip1, inputvect_permut(8) - zv_nvip1);
      pionphoton2_tmp = Getphoton4vector(inputvect_permut(10), inputvect_permut(11) - xv_nvip1, inputvect_permut(12) - yv_nvip1, inputvect_permut(13) - zv_nvip1);
    ...
    // without kin.fit
    TLorentzVector TLVector_isrpho = Getphoton4vector(inputvect_ordered(0),inputvect_ordered(1) - xv_nvip1, inputvect_ordered(2) - yv_nvip1, inputvect_ordered(3) - zv_nvip1);
    TLorentzVector TLVector_pi0pho1 = Getphoton4vector(inputvect_ordered(5), inputvect_ordered(6) - xv_nvip1, inputvect_ordered(7) - yv_nvip1, inputvect_ordered(8) - zv_nvip1);
    TLorentzVector TLVector_pi0pho2 = Getphoton4vector(inputvect_ordered(10), inputvect_ordered(11) - xv_nvip1, inputvect_ordered(12) - yv_nvip1, inputvect_ordered(13) - zv_nvip1);
    ...
    */
    ...
    TLorentzVector TLVector_isrpho_kinfit7C = Getphoton4vector(inputvect_fitted_ordered(0), inputvect_fitted_ordered(1) - xv_nvip1, inputvect_fitted_ordered(2) - yv_nvip1, inputvect_fitted_ordered(3) - zv_nvip1);
    TLorentzVector TLVector_pi0pho1_kinfit7C = Getphoton4vector(inputvect_fitted_ordered(5), inputvect_fitted_ordered(6) - xv_nvip1, inputvect_fitted_ordered(7) - yv_nvip1, inputvect_fitted_ordered(8) - zv_nvip1);
    TLorentzVector TLVector_pi0pho2_kinfit7C = Getphoton4vector(inputvect_fitted_ordered(10), inputvect_fitted_ordered(11) - xv_nvip1, inputvect_fitted_ordered(12) - yv_nvip1, inputvect_fitted_ordered(13) - zv_nvip1);
