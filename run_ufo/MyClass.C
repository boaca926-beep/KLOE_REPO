...
void MyClass::Main()
{
  ...
  double evnt_pre = 0, evnt_str = 0, evnt_trig = 0, evnt_filfo = 0, evnt_trk = 0, evnt_clust = 0, evnt_final = 0.;
  double evnt_phi5 = 0;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    */
    ...
    //if (trigger_indx == 0 || filfo_indx == 0 || evtcls_indx == 0) continue;
    ...
    if (trknb_prompt != 2 || ifbroken ) continue;
    evnt_trk ++; 
