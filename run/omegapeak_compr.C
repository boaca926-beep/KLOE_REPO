...
int omegapeak_compr() {
  ...
  double width_smear = fit_fun -> GetParameter(2);
  double width_smear_err = fit_fun -> GetParError(2);
  double width_rec = fit_fun_rec -> GetParameter(2);
  double width_rec_err = fit_fun_rec -> GetParError(2);
