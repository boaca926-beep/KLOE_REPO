...
#include "/home/bo/Desktop/analysis_root_v6/crx3pi_UFOKslCut/output/sfw2d.txt"
#include "/home/bo/Desktop/analysis_root_v6/crx3pi_UFOKslCut/output/sfw1d.txt"
#include "../header/method.h"
#include "../header/omega_fit_ufo.h"
...
int omega_fit_ufo(){
  ...
  TH1D *hkpm = (TH1D *) HIM3pi_fit -> FindObject("h1d_IM3pi_TKPM") -> Clone();
  TH1D *hrhopi = (TH1D *) HIM3pi_fit -> FindObject("h1d_IM3pi_TRHOPI") -> Clone();
